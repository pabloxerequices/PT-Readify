...
namespace BusinessLogicLayer
{
    public class BLL
    {
        public class Clientess
        {
            ...
            static public void RegistrarCliestess(int Numero_telefone, string Palavra_Passe, string Email, string Nome)
            {
                DAL dal = new DAL();
                ...
                dal.executarNonQuery("INSERT into Clientes ( Numero_telefone, Palavra_Passe, Email, Nome) VALUES(@Numero_telefone, @Palavra_Passe, @Email, @Nome)", sqlParams);
